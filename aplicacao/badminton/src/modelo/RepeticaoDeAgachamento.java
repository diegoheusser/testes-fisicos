//RepeticaoDeAgachamento.java
//Classe modelo do teste: repetição de agachamento
package modelo;
 ...
 */
public class RepeticaoDeAgachamento implements Teste {
    ...
    @Override
    @Coluna(nome="Quantidade",posicao=3,editavel=true)

//TempoDeReacaoRegua.java
//Classe modelo do teste: tempo de reação da régua
package modelo;
 ...
 */
public class TempoDeReacaoRegua implements Teste {
    ...
    @Override
    @Coluna(nome = "Milisegundos", posicao = 3, editavel = true)
    ...
    public void setObjeto(Object objeto) {
        int o =new util.Regex().toMilesegundos(

//FlexibilidadeDeOmbroEPunho.java
//Classe modelo do teste: Flexibilidade de ombro e punho
package modelo;
 ...
 */
public class FlexibilidadeDeOmbroEPunho implements Teste {
    ...
    public FlexibilidadeDeOmbroEPunho() {
        data = new Date();
